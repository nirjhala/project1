<template>
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            <h3>505 Forbidden Error</h3>
            <ul>
                <li>
                    <router-link :to="{ name: 'dashboard' }">Dashboard</router-link>
                </li>
                <li>505 Forbidden Error</li>
            </ul>
        </div>
        ...
        <div class="card h-auto">
            <div class="card-body text-center">
                <p>&nbsp;</p>
                <div style="font-size: 128px; line-height: 100%;">
                    <i class="icon-error_outline text-warning"></i>
                </div>
                <h3 class="text-warning">Access Denied</h3>
                <p>You don't have enough permission to access this page, please contact your administrator.</p>
            </div>
        </div>
    </div>
</template>
