                ...
                <div class="nav-bar-header-one">
                    <div class="header-logo">
                        <a href="./" class="text-white text-uppercase">
                            ...
                            {{ user_info.school_data && user_info.school_data.name ? user_info.school_data.name : '' }}
                        </a>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="item-content">
                                    <ul class="settings-list">
                                        <li>
                                            <router-link :to="{ name: 'edit-profile' }"><i class="icon-user2"></i> My Profile</router-link>
                                        </li>
                                        <li v-if="user_info.role_name.name == 'School'">
                                            <router-link :to="{ name: 'settings' }"><i class="icon-settings1"></i> General Settings</router-link>
                                        </li>
                                        <li v-if="user_info.role_name.name == 'School'">
                                            <router-link :to="{ name: 'FeeSetting' }"><i class="icon-settings1"></i> Fees Settings</router-link>
                                        </li>
                                        <li>
                                            <router-link :to="{ name: 'change-password' }"><i class="icon-lock3"></i> Change Password</router-link>
                                        </li>
                                        <li>
