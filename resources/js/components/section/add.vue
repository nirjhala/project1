                    ...
                    <form class="new-added-form" @submit.prevent=" id ? updateData() : addSession()">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <select class="form-control sectionDept" v-model="sectionDept" v-on:change="getClasses" required>
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>Class</label>
                                <select class="form-control" v-model="sectionClass" required>
                            ...
                            <div class="col-xl-2 col-lg-2 col-12 form-group">
                                ...
                                <select class="form-control" v-model="sectionNo" v-on:change="addSectionsText" required>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-12 form-group" v-for="(n, index) in sectionNo" :key="index">
                                <label>Name *</label>
                                <input type="text" v-model="sectionNames[index]" placeholder="" class="form-control">
                            </div>
                        </div>
                        <div class="row">
