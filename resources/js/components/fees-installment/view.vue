...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        ...
        <h3>Fees Installment</h3>
        <ul>
            <li>
                <router-link :to="{ name: 'dashboard' }">Dashboard</router-link>
            </li>
            <li>Fees Installment</li>
        </ul>
    </div>
                ...
                <div v-if="loaded">
                    <div class="heading-layout1">
                        <div class="item-title">
                            <h3>All Fees Installment Data</h3>
                        </div>
                        ...
                        <table class="table display data-table text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="(list, i) in lists.data">
                                    ...
                                    <td><router-link :to="{ path: 'edit-fees-installment/'+list.id, params: list }" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> {{ list.name }}</router-link></td>
                                    <td>{{ list.start_month }}</td>
...
export default {
    ...
    methods: {
        ...
        searchData(page) {
            ...
            instance.get('search-fees-installment/?page='+page+'&s='+s)
                .then(res => {
                    this.loaded = 1;
                    if(res.status) {
        ...
        getRecords(page) {
            ...
            instance.get('view-fees-installment/?page='+page)
                .then(res => {
                    this.loaded = 1;
                    if(res.status) {
                        this.lists  = res.data.data;
            ...
            if( this.check.length > 0 ) {
                ...
                .then((willDelete) => {
                  if (willDelete) {
                      ...
                      instance.post('remove-fees-installment', params)
                          .then(res => {
                              if(res.status) {
                                  this.getRecords();
