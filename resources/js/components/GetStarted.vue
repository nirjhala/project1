...
<div class="login-page-wrap">
    <div class="login-page-content">
        <div class="login-box">
            ...
            <form class="login-form get-started-form" @submit.prevent="getStarted()">
                <div class="form-group">
                    <label>Mobile No.</label>
                    <input type="tel" placeholder="Enter Mobile No." v-model="mobile" class="form-control mobile" required>
...
export default {
    ...
    methods: {
        getStarted: function() {
            ...
            if (is_valid) {
                axios.post('/school-management/api/get-started', params)
                    .then(res => {
                        if (res.data.status) {
