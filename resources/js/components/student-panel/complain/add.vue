                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12 form-group" v-if="record.against == 'Teacher'">
                                ...
                                <select v-model="record.teacher_id" class="form-control" required>
                                    ...
                                    <option :value="t.id" v-for="(t, i) in teachers" :key="i">{{ t.name }}</option>
                                </select>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        addData: function () {
            ...
            instance.post('complain', params)
                .then(res => {
                    if(res.data.status) {
                        this.$router.push({ name: 'view-complain' })
                            .then(
                                res => {
                                    this.loaded = 1;
        ...
        updateData: function () {
            ...
            instance.put('complain/'+this.id, params)
                .then(res => {
                    if(res.data.status) {
                        this.$router.push({ name: 'view-complain' })
                            .then(
