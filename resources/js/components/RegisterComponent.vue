  ...
  <div class="register-page-wrap">
    <div class="register-page-content">
      <div class="clearfix mb-5">
        <div class="float-left h-100" style="width: 40%">
          <div class="register-wizard-steps d-flex">
            <ul>
              <li class="active" data-tab="#login-information">
                <a href="#">Login Information</a>
              </li>
              <li data-tab="#personal-information">
                <a href="#">Personal Information</a>
              </li>
              <li data-tab="#plan-information">
            ...
            >
              <div class="wizard-tab active" id="login-information">
                ...
                <div class="form-group mb-0">
                  <button
                    type="button"
                    class="login-btn wizard-next-btn"
                    data-target="#personal-information"
                  >
                    Proceed
                  </button>
                </div>
              ...
              <div class="wizard-tab" id="plan-information">
                <div class="row">
                  <div class="col-6" v-for="(p, i) in plans" :key="i">
                ...
                <div class="form-group">
                  <a :href="landingBase + 'pricing.php'" target="_blank"
                    >Click Here</a
                  >
      ...
      <div class="sign-up">
        ...
        <router-link :to="{ name: 'get-started' }">Login now!</router-link>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    getPlans() {
      axios.get(this.baseURL + "api/get-all-plans").then((res) => {
        this.plans = res.data;
    ...
    getCities() {
      ...
      axios
        .post(this.baseURL + "api/get-cities-by-state", params)
        .then((res) => {
          this.cities = res.data;
        });
    },
    getStates() {
      axios.get(this.baseURL + "api/get-all-states").then((res) => {
    ...
    registerUser() {
      ...
      if (is_valid) {
        ...
        axios
          .post(this.baseURL + "api/school-register", params)
          .then((res) => {
            if (res.data.status) {
              swal(
                "Success!!",
                "You are registered successfully, you will be redirected to your portal.",
                "success"
              ).then(() => {
    ...
    loadJquery() {
      $(document).on("click", ".wizard-next-btn", function (e) {
        let btn = $(e.target);
        let parent = btn.closest(".wizard-tab"),
      ...
      $(document).on("click", ".wizardBtn", function (e) {
        let btn = $(e.target);
        let parent = btn.closest(".step-wizard-panel"),
          target = btn.data("target"),
          sel = $(target);
