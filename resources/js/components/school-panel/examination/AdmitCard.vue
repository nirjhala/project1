    ...
    <div class="dashboard-content-one" style="text-transform: capitialize">
        ...
        <div class="breadcrumbs-area">
            ...
            <ul>
                ...
                <li>{{ $route.params.type }} Admit Card</li>
            </ul>
        </div>
                                ...
                                <table class="table display data-table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr v-for="(list, i) in lists" v-bind:key="i">
                                            ...
                                            <td>
                                                <a 
                                                    :href="`${baseURL}api/admit-card/${exam_type_id}/${list.id}`"
                                                    target="_blank"
                                                >
...
import api, { multiple_delete_tc, view_admit_card, view_all_classes, view_exam_type, view_sch_certificate, view_tc } from '../../../api/script'
    ...
    methods: {
        ...
        showAdmitCards () {
            if(this.section_id && this.exam_type_id) {
                this.loaded = 0
                view_admit_card (`section_id=${this.section_id}&exam_type_id=${this.exam_type_id}`)
                    .then(res => {
                        this.lists = res.data
                        this.loaded = 1
                    })
