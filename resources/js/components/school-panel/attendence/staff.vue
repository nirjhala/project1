          ...
          <div v-if="loaded">
            <div id="timetable">
              <div class="table-responsive" v-if="lists">
                <table
                  class="table display table-bordered table-sm text-nowrap"
                >
                    ...
                    <tr v-for="(x, i) in users" :key="i">
                      ...
                      <td class="text-center">
                        <div class="onoffswitch d-inline-block my-1">
                          ...
                          />
                          <label
                            class="onoffswitch-label m-0 text-left"
                            :for="'attd_btn' + x.id"
                          >
...
export default {
  ...
  methods: {
    saveAttendence() {
      ...
      instance.post("save-attendence", params).then((res) => {
