    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            <div class="float-right">
                <router-link :to="{ name: 'fees-installment' }" class="fw-btn-fill btn-gradient-yellow text-white">View Fees Installment</router-link>
            </div>
            ...
            <ul>
                ...
                <li>
                    <router-link :to="{ name: 'fees-installment' }">Fees Installment</router-link>
                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <select class="form-control" v-model="start_month" required>
                                    ...
                                    <option :value="m" v-for="m in months" :key="m">{{ m }}</option>
                                </select>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
...
export default {
    ...
    methods: {
        getInfo(id) {
            ...
            instance.get('get-fees-installment-info/'+id)
                 .then( res => {
        ...
        addData: function () {
            ...
            instance.post('add-fees-installment', params)
                .then(res => {
                    if(res.data.status) {
                        this.$router.push({ name: 'fees-installment' })
                            .then(
                                res => {
                                    this.loaded = 1;
        ...
        updateData: function () {
            ...
            instance.post('update-fees-installment', params)
                .then(res => {
                    if(res.data.status) {
                        this.$router.push({ name: 'fees-installment' })
                            .then(
