...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        <div class="float-right">
            <router-link :to="{ name: 'add-class' }" class="fw-btn-fill btn-gradient-yellow text-white">Add New</router-link>
        </div>
        <h3>Class</h3>
        <ul>
            <li>
    ...
    <div class="mg-b-20">
        <div class="row gutters-8">
            ...
            <!-- <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                    <button type="button" @click="searchData()" class="fw-btn-fill btn-gradient-yellow">SEARCH</button>
                </div> -->
        </div>
    </div>
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr v-for="(list, i) in lists.data" :key="i">
                                        ...
                                        <td>
                                            <router-link :to="{ path: 'edit-class/'+list.id, params: list }" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> {{ list.name }}</router-link>
                                            <div>
...
export default {
    ...
    methods: {
        ...
        searchData(page) {
            ...
            instance.get('search-class/?page=' + page + '&s=' + s)
                .then(res => {
                    this.loaded = 1;
                    if (res.status) {
        ...
        getRecords(page) {
            ...
            instance.get('view-class/?page=' + page)
                .then(res => {
                    this.loaded = 1;
                    if (res.status) {
                        this.lists = res.data.data;
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            instance.post('remove-class', params)
                                .then(res => {
                                    if (res.status) {
                                        this.getRecords();
