              ...
              <table class="table display data-table text-nowrap">
                ...
                <tbody>
                  <tr v-for="(list, i) in lists.data" :key="i">
                    ...
                    <td>
                      <router-link
                        :to="{ path: 'edit-religion/' + list.id, params: list }"
                        data-toggle="tooltip"
                        title="Edit"
                        ><i class="fa fa-edit"></i> {{ list.name }}</router-link
                      >
                      <div>
                        <small>({{ list.students_count }} students)</small>
                      </div>
                    </td>
                  </tr>
                </tbody>
...
export default {
  ...
  methods: {
    ...
    searchData(page) {
      ...
      instance
        .get("search-religion/?page=" + page + "&s=" + s)
        .then((res) => {
          this.loaded = 1;
          if (res.status) {
