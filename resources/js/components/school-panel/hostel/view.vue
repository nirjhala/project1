              ...
              <table class="table display data-table text-nowrap">
                ...
                <tbody>
                  <tr v-for="(list, i) in lists.data" :key="i">
                    ...
                    <td>
                      <router-link
                        :to="{ path: 'edit-hostel/' + list.id, params: list }"
                        data-toggle="tooltip"
                        title="Edit"
                    ...
                    <td>
                      <span
                        v-if="list.city_name && list.city_name.state_name"
                        >{{ list.city_name.state_name.name }}</span
                      >
                    </td>
                    <td>
                      <span v-if="list.city_name">{{
                        list.city_name.name
                      }}</span>
                    </td>
                    <td>
...
import { remove_hostel, view_hostel } from "../../../api/hostel";
...
export default {
  ...
  methods: {
    ...
    getRecords(page) {
      ...
      this.loaded = 0;
      view_hostel(`page=${page}&s=${this.s}`)
        .then((res) => {
          this.loaded = 1;
          if (res.status) {
