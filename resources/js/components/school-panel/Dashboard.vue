<template>
  <div class="dashboard-content-one" v-if="dashboard_data.count">
            ...
            <div class="col-6">
              <div class="item-content">
                ...
                <div class="item-number">
                  <span
                    class="counter"
                    :data-num="dashboard_data.count.student"
                  >
                    {{ dashboard_data.count.student }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="item-content">
                ...
                <div class="item-number">
                  <span
                    class="counter"
                    :data-num="dashboard_data.count.teacher"
                  >
                    {{ dashboard_data.count.teacher }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="item-content">
                ...
                <div class="item-number">
                  <span
                    class="counter"
                    :data-num="dashboard_data.count.parents"
                  >
                    {{ dashboard_data.count.parents }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="item-content">
                ...
                <div class="item-number">
                  ...
                  <span
                    class="counter"
                    :data-num="dashboard_data.count.total_sales_paid"
                  >
                    {{ dashboard_data.count.total_sales_paid }}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="notice-box-wrap">
              <div class="notice-list">
                ...
                <h6 class="notice-title">
                  <a href="#"
                    >Great School manag mene esom text of the printing.</a
                  >
                </h6>
