  ...
  <div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
      <div class="float-right">
        <router-link
          :to="{ name: 'AddUser', params: { role: title } }"
      ...
      <b-row class="gutters-8 mb-2">
        ...
        >
          ...
          >
            ...
            <option :value="id" v-for="(name, id) in cf.options" :key="id">
              {{ name }}
            </option>
          </select>
                ...
                <table class="table display data-table text-nowrap">
                  ...
                  <tbody>
                    <tr v-for="(list, i) in lists.data" v-bind:key="i">
                      <td>
                        <div class="form-check" v-if="!list.children_count">
                          <input
                            v-model="check"
                            :key="lists.from + i"
                            :value="list.id"
                      ...
                      <td>
                        ...
                        >
                        <div v-if="list.children_count">
                          <small>({{ list.children_count }} students)</small>
                        </div>
                      </td>
                      <td>
                        <div v-if="list.media">
                      ...
                      <td>
                        ...
                        <div
                          v-if="!list.city_data || !list.city_data.state_name"
                        >
                          &mdash;
                        </div>
                      </td>
                      <td>
                        <div v-if="list.city_data">
                          {{ list.city_data.name }}
                        </div>
