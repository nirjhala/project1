    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            <div class="float-right">
                <router-link :to="{ name: 'ViewUser', params: { role: page_title } }" class="fw-btn-fill btn-gradient-yellow text-white">View {{ page_title }}</router-link>
            </div>
            ...
            <ul>
                ...
                <li>
                    <router-link :to="{ name: 'ViewUser', params: {role: page_title} }">{{ page_title }}</router-link>
                </li>
                    ...
                    <form @submit.prevent=" id ? updateData() : addData()">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                >
                                <b-form-invalid-feedback v-if="!$v.mobile.required">Please enter mobile no.</b-form-invalid-feedback>
                                <b-form-invalid-feedback v-if="!$v.mobile.mobileNo">Please enter valid 10 digit mobile no.</b-form-invalid-feedback>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                >
                                <b-form-invalid-feedback>Please enter password.</b-form-invalid-feedback>
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-xl-4 col-12 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select title</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-4 col-12 form-group">
                                        ...
                                        >
                                        <b-form-invalid-feedback v-if="!$v.fname.required">Please select title</b-form-invalid-feedback>
                                        <b-form-invalid-feedback v-if="$v.fname.required">Please don't enter any special symbol or numeric value.</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-4 col-12 form-group">
                                        ...
                                        >
                                        <b-form-invalid-feedback v-if="!$v.lname.alphaOnly">Please don't enter any special symbol or numeric value.</b-form-invalid-feedback>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select gender.</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-4 col-12 form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                    <b-form-invalid-feedback>Please fill address line 1.</b-form-invalid-feedback>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-12 form-group">
                                        ...
                                        >
                                            ...
                                            <option 
                                                :value="s.id" v-for="(s, i) in states"
                                                :key="i"
                                            >{{ s.name }}, {{ s.country_name.name }}</option>
                                        </select>
                                    ...
                                    <div class="col-xl-4 form-group">
                                        ...
                                        >
                                            ...
                                            <option :value="s.id" v-for="(s, i) in cities" :key="i">{{ s.name }}</option>
                                        </select>
                                    ...
                                    <div class="col-xl-4 col-12 form-group">
                                        ...
                                        >
                                        <b-form-invalid-feedback v-if="!$v.pin_code.required">Please select pincode</b-form-invalid-feedback>
                                        <b-form-invalid-feedback v-if="$v.pin_code.required">Please enter valid 6 digit pincode</b-form-invalid-feedback>
                                    </div>
                                </div>
                                ...
                                <b-row v-if="custom_fields.length">
                                    ...
                                    >
                                        ...
                                        <textarea 
                                            ...
                                            style="height: 200px"
                                        ></textarea>
                                        <select v-model="custom_field[cf.id]" class="form-control" v-if="cf.type == 'relation'">
...
<script>
    ...
    import api, { view_certificate, addUserCertificate, view_custom_fields } from '../../../api/script'
    ...
    export default {
        ...
        methods: {
            ...
            fetchCertificates () {
                view_certificate(this.page_title.toLowerCase())
                    .then(res => {
            ...
            updateData: function() {
                ...
                instance.post(`user/${this.id}`, params)
                    .then(res => {
                        if (res.data.status) {
                            this.$router.push({
                                    name: 'ViewUser',
