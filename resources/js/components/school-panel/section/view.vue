        ...
        <div class="card-body">
          ...
          <div v-if="loaded">
            ...
            <div
              ...
              v-if="!lists || !lists.data || !lists.data.length"
            >
              ...
              <table class="table display data-table text-nowrap">
                ...
                <tbody>
                  <tr v-for="(list, i) in lists.data" :key="i">
                    ...
                    <td>
                      <router-link
                        :to="{ path: 'edit-section/' + list.id, params: list }"
                        data-toggle="tooltip"
                        title="Edit"
...
import { remove_section, view_section } from "../../../api/section";
...
export default {
  ...
  methods: {
    ...
    getRecords(page = 1) {
      ...
      this.loaded = 0;
      view_section(`page=${page}&s=${this.s}`)
        .then((res) => {
          this.loaded = 1;
          if (res.status) {
