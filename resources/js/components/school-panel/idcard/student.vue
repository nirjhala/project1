  ...
  <div class="dashboard-content-one">
        ...
        <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
          ...
          >
            ...
            <optgroup :label="cls.name" v-for="(cls, i) in classes" :key="i">
              <option :value="s.id" v-for="(s, j) in cls.sections" :key="j">
                {{ cls.name }} - {{ s.name }}
              </option>
            </optgroup>
          </select>
    ...
    <form method="post" v-if="section">
      <div class="card height-auto">
            ...
            >
              ...
              >
                ...
                <div style="text-align: center">
                  ...
                  <div
                    style="letter-spacing: 5px; font-size: 8px; margin: 2px 0"
                  >
                    {{ s.barcode }}
                  </div>
                </div>
        ...
        <div>
          <button type="button" v-on:click="printIdCards()" class="btn-main">
            Print
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getStudents() {
      ...
      instance
        .get("get-student-by-section/" + this.section)
        .then((res) => {
          this.loaded = 1;
          if (res.status) {
