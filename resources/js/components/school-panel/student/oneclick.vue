                ...
                <div class="card-body">
                    <div class="gutters-8">
                        <div class="form-group">
                            <multiselect v-model="student" track-by="uid" placeholder="Select Student" select-label="" deselect-label="" :options="students" :custom-label="studentLabel" :searchable="true" :allow-empty="false">
                    ...
                    <div v-if="student">
                        <div class="mb-3 table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>CLASS</th>
                                    <td>{{ `${student.section_name.cls.name}-${student.section_name.name}` }}</td>
                                </tr>
                            </table>
                        </div>
                        <b-row>
                            <b-col sm="3" v-for="(act, i) in clickActions" :key="i">
                                <router-link :to="act.link" v-if="act.link" class="btn btn-dark btn-lg btn-block py-4 mb-3">{{ act.label }}</router-link>
                                <button type="button" @click="handle_function_call(act.click)" v-if="act.click" class="btn btn-dark btn-lg btn-block py-4 mb-3">{{ act.label }}</button>
                            </b-col>
                        </b-row>
                    </div>
