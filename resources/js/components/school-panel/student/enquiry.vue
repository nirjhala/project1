    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            ...
            <ul>
                ...
                <li>
                    <router-link :to="{ name: 'StudentMaster' }">Admission Master</router-link>
                </li>
        ...
        <div class="mg-b-20">
            <div class="row gutters-8">
                <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                    <input type="text" v-model="s" placeholder="Search ..." class="form-control">
                </div>
            </div>
        </div>
                                        ...
                                        <tr v-for="(list, i) in lists.data" :key="i">
                                            ...
                                            <td>
                                                <ul class="list-item-group">
                                                    <li class="list-item"><strong>Name: </strong> {{ list.name }}</li>
                                                    <li class="list-item"><strong>Father: </strong> {{ list.father_name }}</li>
                                                    <li class="list-item"><strong>Mother: </strong> {{ list.mother_name }}</li>
                                                </ul>
                                            </td>
                                            <td>
                                                <ul class="list-item-group">
                                                    <li class="list-item"><strong>Mobile: </strong> {{ list.mobile }}</li>
                                                    <li class="list-item"><strong>Phone: </strong> {{ list.phone }}</li>
                                                    <li class="list-item"><strong>Email: </strong> {{ list.email }}</li>
                                                </ul>
                                            </td>
                                            <td>
                                                <ul class="list-item-group">
                                                    <li class="list-item"><strong>Gender: </strong> {{ list.gender }}</li>
                                                    <li class="list-item"><strong>DOB: </strong> {{ list.dob }}</li>
                                                </ul>
                                            </td>
                                            <td>{{ list.address }}<br>{{ list.city + ' ' + list.state + ' ' + list.postcode }}</td>
                                        </tr>
                                    </tbody>
                                </table>
