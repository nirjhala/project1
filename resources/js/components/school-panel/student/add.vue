    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            <div class="float-right">
                <router-link :to="{ name: 'ViewStudent' }" class="fw-btn-fill btn-gradient-yellow text-white">View Student</router-link>
            </div>
        ...
        <div class="card mb-3 h-auto">
            <div class="step-wizard-tabs card-body">
                <ul>
                    <li class="current">
                        <a @click="scrollToSection('#general-info')" href="#general-info"><span class="step-no">1</span> General Info</a>
                    </li>
                    <li>
                        <a @click="scrollToSection('#admission-info')" href="#admission-info"><span class="step-no">2</span> Admission Info</a>
                    </li>
                    <li>
                        <a @click="scrollToSection('#documents-info')" href="#documents-info"><span class="step-no">2</span> Student Documents</a>
                    </li>
                    <li>
                        <a @click="scrollToSection('#gaurdian-info')" href="#gaurdian-info"><span class="step-no">3</span> Guardian Info</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div id="general-info" class="card height-auto">
                    <div class="card-body">
                        ...
                        <div v-if="loaded">
                            ...
                            <b-form method="post" @submit.prevent="!$route.params.id ? addUser() : updateUser()">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        >
                                        <b-form-invalid-feedback>{{ !$v.user.mobile.required ? 'This is a required field.' : 'Enter valid 10 digit mobile no.' }}</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>Login *</label>
                                        <input 
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        >
                                        <i class="far fa fa-eye passwordToggle input-icon" style="cursor: pointer"></i>
                                        <b-form-invalid-feedback>This is a required field.</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label>&nbsp;</label>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-12 form-group">
                                                ...
                                                >
                                                <b-form-invalid-feedback>{{ !$v.user.fname.required ? 'This is a required field.' : 'Please enter only characters.' }}</b-form-invalid-feedback>
                                            </div>
                                            <div class="col-xl-4 col-12 form-group">
                                                ...
                                                >
                                                <b-form-invalid-feedback>Please enter only characters.</b-form-invalid-feedback>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="user.address2" class="form-control">
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-4 form-group">
                                                <label>City *</label>
                                            ...
                                            <div class="col-xl-4 col-12 form-group">
                                                ...
                                                >
                                                <b-form-invalid-feedback>{{ !$v.user.pin_code.required ? 'This is a required field.' : 'Please enter valid 6 digit postcode.' }}</b-form-invalid-feedback>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" v-model="user.image" value="" id="featuredImageId">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group mg-t-8 text-right">
                                        <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">{{ $route.params.id ? 'Update' : 'Save'}}</button>
                                    </div>
                                </div>
                            </b-form>
                        </div>
                            ...
                            <form method="post" @submit.prevent="updateStudent()">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-12 form-group">
                                        ...
                                        >
                                        <b-form-invalid-feedback>Please enter Entrollment No.</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-3 col-12 form-group">
                                        <label>Roll No.</label>
                                        <input type="text" v-model.trim="student.roll_no" class="form-control">
                                    </div>
                                    <div class="col-xl-3 col-12 form-group">
                                    ...
                                    <div class="col-xl-3 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select category</b-form-invalid-feedback>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-3 col-12 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select religion.</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-3 col-12 form-group">
                                        <label>Cast *</label>
                                        <input 
                                        ...
                                        >
                                        <b-form-invalid-feedback>Please enter student's cast</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-3 col-12 form-group">
                                        ...
                                        >
                                            ...
                                            <optgroup
                                                ...
                                                :key="i"
                                            >
                                                <option :value="s.id" v-for="s in c.sections" :key="s.id">{{ c.name }} - {{ s.name }} ({{ c.dept.dept_name }})</option>
                                            </optgroup>
                                        </select>
                                        <b-form-invalid-feedback>Please select your class and section</b-form-invalid-feedback>
                                    </div>
                                </div>
                        ...
                        <div v-if="loaded">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row mb-2" v-for="(c,i) in certificates" :key="i">
                                    <div class="col-6">
                                        {{ c.en_name }} <span v-if="c.short_name"> - {{ c.short_name }}</span> ({{ c.hi_name }})

                                        <a :href="user_certificates[c.id]" v-if="user_certificates[c.id]" target="_blank">VIEW / DOWNLOAD FILE</a>
                                    </div>
                                    <div>
                            ...
                            <form method="post" @submit.prevent="updateParentInfo()">
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-12 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select father's name</b-form-invalid-feedback>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-12 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select mother's name</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-2 col-lg-6 col-12 form-group">
                                        <label>&nbsp;</label>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select any one option</b-form-invalid-feedback>
                                    </div>
                                    <div class="col-xl-5 col-lg-6 col-12 form-group">
                                        ...
                                        <input 
                                            ...
                                            class="form-control"
                                            :class="{ 'is-invalid': $v.parent.guardian_relation.$error }"
                                        >
                                        <b-form-invalid-feedback>Please enter relation name</b-form-invalid-feedback>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-12 form-group">
                                        ...
                                        <b-form-invalid-feedback>Please select guardian</b-form-invalid-feedback>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <b-form method="post" @submit.prevent=" addParent()">
                            ...
                            <div class="form-group">
                                <input type="text" v-model="parentName" placeholder="Name" class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" v-model="parentType" placeholder="Type" class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" v-model="parentMobile" placeholder="Mobile No." class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="password" v-model="parentPassword" placeholder="Password" class="form-control">
                            </div>
...
<script>
    ...
    import { addStudent, updateStudentData, view_all_states, view_all_classes, studentInfo, view_certificate, addUserCertificate } from "../../../api/script.js"
        ...
        validations: {
            user: {
                ...
                mobile: {
                    ...
                    mobileNo (mobile) {
                        return (
                            /[0-9]{10}/.test(mobile) && mobile.length == 10
                        )
                    },
        ...
        methods: {
            ...
            getInfo(id) {
                studentInfo(id)
                    .then(res => {
                        ...
                        let relationName  = res.data.guardian_relation != null ? res.data.guardian_relation.toLowerCase() : '';
                        ...
                        let media_image    = res.data.user.image != null ? res.data.user.image : '';
                        let media_src      = res.data.media ? res.data.media.image_url.medium : this.baseURL+'/img/default.jpg';
            ...
            updateUser () {
                ...
                if (this.$v.user.$anyError) {
                    ...
                    updateStudentData(this.$route.params.id, { _method: 'PUT', user: this.user })
                        .then((res) => {
                            this.$router.push({
                                name: 'EditStudent', 
                                params: {
