                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Monday" value="Y" @change="updateWeekday()">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Tuesday" value="Y" @change="updateWeekday()">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-8">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Wednesday" value="Y" @change="updateWeekday()">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-8">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Thursday" value="Y" @change="updateWeekday()">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-8">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Friday" value="Y" @change="updateWeekday()">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-8">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Saturday" value="Y" @change="updateWeekday()">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-8">
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <label class="switch">
                                        <input type="checkbox" v-model="Sunday" value="N" @change="updateWeekday()">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="col-8">
...
export default {
    ...
    methods: {
        updateWeekday() {
            ...
            instance.post('save-weekday', params)
                .then(res => {
                    console.log('saved.');
                });
        },
