        ...
        <div v-if="loaded">
          <div class="form-group">
            <select v-model="month" class="form-control">
              <option :value="m" v-for="m in allMonths" :key="m">
                {{ m }}
              </option>
            </select>
          </div>
            ...
            <div class="table-responsive" v-if="attdLists">
              <div v-for="(m, i) in attdLists" :key="'m_' + i">
                ...
                <div class="d-flex flex-wrap">
                  ...
                  >
                    <div
                      class="d-flex align-items-center justify-content-center text-center w-100 text-center"
                    >
                      <div style="font-size: 36px; width: 60px">
                        {{ d.date }}
                      </div>
                      <div
                        class="flex-fill"
...
export default {
  ...
  methods: {
    getHolidays() {
      let apiResponse = api.getAllHolidays();
      apiResponse
        .then((res) => {
          this.loaded = 1;
          this.lists = res.data;
