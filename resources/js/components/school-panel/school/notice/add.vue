    ...
    <div class="dashboard-content-one">
        ...
        <div class="card height-auto">
            <div class="card-body">
                ...
                <div v-if="loaded">
                    <form @submit.prevent=" $route.params.id ? updateData() : addData()" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-12 form-group mg-t-8">
                                <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">{{ !$route.params.id ? 'Save' : 'Update' }}</button>
