                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <tbody>
                                        <tr
                                            v-for="(row, i) in lists.data"
                                            :key="i"
                                        >
                                            <td>
                                                <div class="form-check">
                                                    <input v-model="check" :key="lists.from + i" :value="row.id" type="checkbox" class="form-check-input check">
                                            ...
                                            <td>{{ `${row.sch_time_from} - ${row.sch_time_upto}` }}</td>
                                            <td>
                                                <a :href="`${onlineClassURL}${row.room_unique_id}`" target="_blank"><i class="icon-video"></i> Start Live Class</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
import { delete_allowance, multiple_delete_employe_promotion, multiple_delete_online_class, view_allowance, view_employe_promotion, view_online_class } from '../../../api/script'
