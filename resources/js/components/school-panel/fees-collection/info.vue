    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            ...
            <ul>
                ...
                <li>
                    <router-link :to="{ name: 'fees-collection' }">Fees Collection</router-link>
                </li>
                <li>Fees Summary</li>
            </ul>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td colspan="2" rowspan="4" class="text-center" style="width: 100px;">
                                    <div><strong>Photograph</strong></div>
                                    <img :src="user_info.picture" alt="" style="max-width: 100px;">
                                </td>
                            </tr>
                            <tr>
                                <th>Father Name</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input type="radio" v-model="admission_type" value="New" @change="calcInstallments()"> New
                                    </label>
                                    <label>
                                        <input type="radio" v-model="admission_type" value="Old" @change="calcInstallments()"> Old
                                    </label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(ft, i) in fees_lists" :key="i">
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" v-model="fees_include" :value="ft.id" @change="calcInstallments()">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <select v-model="no_of_installments" class="form-control" @change="calcInstallments()">
                                ...
                                <tr>
                                    <th>Discount</th>
                                    <td colspan="2">
                                        <input type="number" v-model="discount" class="form-control" @change="calcInstallments()">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Final Amount</th>
            ...
            <div class="card-body">
                <div>
                                ...
                                <tr v-for="num in no_of_installments" :key="num">
                                    ...
                                    <td>
                                        <select v-model="payement_month[num]" class="form-control">
                                            ...
                                            <option :value="m" v-for="m in 12" :key="m">{{ m }}</option>
                                        </select>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-success" @click="saveInstallments()">Save &amp; Submit</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getInfo(id) {
            ...
            instance.get(`fees/info/student/${id}`)
                 .then( res => {
                     let self = this
                     let list       = res.data
        ...
        saveInstallments: function () {
            ...
            instance.post('fees-structure/'+this.id, params)
                .then(res => {
                    if(res.data.status) {
