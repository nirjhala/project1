                ...
                <form class="new-added-form" @submit.prevent="updateData()">
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-4 form-group">
                                    ...
                                    <div>
                                        <label class="custom-radio">
                                            <input type="radio" name="title" v-model="title" value="Mr.">
                                            <span>Mr.</span>
                                        </label>
                                        <label class="custom-radio">
                                            <input type="radio" name="title" v-model="title" value="Ms.">
                                            <span>Ms.</span>
                                        </label>
                                        <label class="custom-radio">
                                            <input type="radio" name="title" v-model="title" value="Mrs.">
                                            <span>Mrs.</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="text" v-model="fname" name="" class="form-control" placeholder="First Name" required>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <label>Last Name</label>
                                    <input type="text" v-model="lname" name="" class="form-control" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    <label>Display Name *</label>
                                    <input type="text" v-model="name" name="" class="form-control" placeholder="Display Name">
                                </div>
                                <div class="col-12 form-group"> </div> <!-- To maintain space -->
                            </div>
                            <div class="row">
                                <div class="col-sm-4 form-group">
                                    <label>Gender *</label>
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="email" v-model="email" name="" class="form-control" placeholder="Email Address" required>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <label>Date of Birth *</label>
                                    <input type="date" v-model="dob" name="" class="form-control" placeholder="Date of Birth" :max="maxDate" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Address Line 1 *</label>
                                <input type="text" v-model="address1" value="" class="form-control" placeholder="Address Line 1" required>
                            </div>
                            <div class="form-group">
                                <label>Address Line 2</label>
                                <input type="text" v-model="address2" value="" class="form-control" placeholder="Address Line 2">
                            </div>
                            <div class="row">
                                <div class="col-sm-4 form-group">
                                    <label>State *</label>
                                ...
                                <div class="col-sm-4 form-group">
                                    <label>City *</label>
                                    <select class="form-control" v-model="city" v-on:change="getPincodes()" required>
                        ...
                        <div class="col-sm-3">
                            ...
                            <button type="button" class="uploadImage btn-fill-lg bg-blue-dark btn-hover-yellow btn-block uploadImageBtn" data-image="#featuredImage" data-field="#featuredImageId">Choose Image</button>
                        </div>
                    </div>
                </form>
            </div>
...
export default {
    ...
    methods: {
        getProfile() {
            ...
            instance.get('get-profile')
                .then(res => {
                    ...
                    this.state = profile.pincode_data && profile.pincode_data.city_name ? profile.pincode_data.city_name.state : '';
                    ...
                    let media_src = profile.media ? this.baseURL + 'uploads/medium/' + profile.media.image : this.baseURL + '/img/default.jpg';
        ...
        updateData: function() {
            ...
            instance.post('update-profile', params)
                .then(res => {
                    this.loaded = 1;
                    if (res.data.status) {
