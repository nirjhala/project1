            ...
            <div class="row">
              <div class="col-sm-9">
                ...
                <div class="form-group">
                  ...
                  <textarea
                    v-model="record.student_id_instructions"
                    rows="8"
                    class="form-control h-auto p-3"
                    placeholder="Address"
                    required
                ...
                <div class="form-group">
                  ...
                  <textarea
                    v-model="record.teacher_id_instructions"
                    rows="8"
                    class="form-control h-auto p-3"
                    placeholder="Address"
                    required
                ...
                <div class="form-group">
                  ...
                  <textarea
                    v-model="record.staff_id_instructions"
                    rows="8"
                    class="form-control h-auto p-3"
                    placeholder="Address"
                    required
              ...
              <div class="col-sm-3">
                <div class="mb-3">
                  ...
                  <label
                    for="siteLogo"
                    class="uploadImage btn-fill-lg bg-blue-dark btn-hover-yellow btn-block text-center"
                    >Choose Image</label
                  >
                </div>
                <div class="mb-3">
...
export default {
  ...
  methods: {
    ...
    getSchoolInfo() {
      ...
      instance.get("get-school-info").then((res) => {
        ...
        let logo_src = profile.logo
          ? this.baseURL + "/img/profiles/" + profile.logo
          : this.baseURL + "/img/default.jpg";

        let favicon_src = profile.favicon
          ? this.baseURL + "/img/profiles/" + profile.favicon
          : this.baseURL + "/img/default.jpg";
    ...
    updateData: function () {
      ...
      instance
        .post("general-settings", formData)
        .then((res) => {
          this.loaded = 1;
          if (res.data.status) {
            // location.reload();
