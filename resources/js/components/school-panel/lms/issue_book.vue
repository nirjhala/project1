                ...
                <div class="card-body">
                    <div>
                        ...
                        <div v-if="loaded">
                            <div class="row mb-3">
                              <div class="col-sm-7">
                                <div class="form-group">
                                  ...
                                  <input type="text" v-model="user" ref="user" class="form-control" v-on:change="scanLibPass()" autofocus>
                                </div>
                                <div class="form-group" v-if="user_info.id">
                                  <label>Scan Book</label>
                                  <input type="text" v-model="book" ref="book" class="form-control" v-on:change="scanLibBook()" autofocus>
                                </div>
                              </div>
                              <div class="col-sm-5">
                            ...
                            <div class="table-responsive mb-3" v-if="books.length && user_info.id">
                            ...
                            <div class="form-group mg-t-8" v-if="user_info.id && books.length">
                              <button type="button" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" v-on:click="saveData()">Submit</button>
    ...
    methods: {
        ...
        scanLibPass() {
          ...
          if(barcode != '' && barcode != undefined) {
            ...
            instance.post('book/pass/info-by-barcode', params)
              .then(res => {
        ...
        scanLibBook() {
          ...
          if(barcode != '' && barcode != undefined && hasMatch == false) {
            ...
            instance.post('book/info-by-barcode', params)
              .then(res => {
        ...
        saveData() {
          ...
          let instance = axios.create({
            ...
            instance.post('lms/book/issue', params)
                .then(res => {
                  if(res.data.status) {
