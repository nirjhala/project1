              ...
              <table class="table display data-table text-nowrap">
                ...
                <tbody>
                  <tr v-for="(list, i) in lists.data" :key="i">
                    ...
                    <td>
                      <router-link
                        :to="{ path: 'book/edit/' + list.id, params: list }"
                        data-toggle="tooltip"
                        title="Edit"
...
export default {
  ...
  methods: {
    ...
    assignClass() {
      ...
      instance.post("assign-book-class", params).then((res) => {
        this.loaded = 1;
    ...
    getAllClasses() {
      ...
      instance.get("get-all-classes").then((res) => {
        this.loaded = 1;
