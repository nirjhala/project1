                                ...
                                <table class="table display data-table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr v-for="(list, i) in lists.data" v-bind:key="i">
                                            ...
                                            <td>{{ list.current_salary }} to {{ list.new_salary }}</td>
...
import { multiple_delete_employe_promotion, view_employe_promotion } from '../../../api/script'
...
export default {
    ...
    methods: {
        ...
        getRecords (page) {
            ...
            this.loaded = 0
            view_employe_promotion (`page=${page}&s=${this.s}`)
                .then(res => {
                    this.lists = res.data
                    this.loaded = 1
                })
