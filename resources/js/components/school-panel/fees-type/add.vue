                ...
                <div v-if="loaded">
                    ...
                    <form class="new-added-form" @submit.prevent=" id ? updateData() : addData()">
                        ...
                        <div class="form-group">
                            <label>Name *</label>
                            <input type="text" v-model="record.name" placeholder="" value="" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-6">
                                    <label class="switch">
                                        <input type="checkbox" v-model="record.installment_availability" value="1">
...
export default {
    ...
    methods: {
        ...
        addData: function () {
            ...
            instance.post('fees-type', params)
                .then(res => {
                    if(res.data.status) {
        ...
        updateData: function () {
            ...
            instance.put('fees-type/'+this.id, params)
                .then(res => {
                    if(res.data.status) {
                        this.$router.push({ name: 'fees-type' })
                            .then(
