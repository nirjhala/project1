    ...
    <div class="dashboard-content-one">
        ...
        <div class="breadcrumbs-area">
            <div class="float-right">
                <router-link :to="{ name: 'ViewGallery' }" class="fw-btn-fill btn-gradient-yellow text-white">View Gallery</router-link>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="form-group" v-if="form.type == 'video'">
                                    ...
                                    <input type="text" v-model="form.video_url" class="form-control" required>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="mb-3">
