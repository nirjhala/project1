<template>
    <div class="dashboard-content-one">
        ...
        <form method="post" @submit.prevent="deleteRecord()">
                                ...
                                <table class="table display data-table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr v-for="(list, i) in lists.data" v-bind:key="i">
                                            ...
                                            <td>
                                                <router-link :to="{ name: 'UpdateAssignment', params: { id: list.id } }" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> {{ list.name }}</router-link>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <router-link :to="{ name: 'AllotAssignment', params: {  id: list.id } }">Allot Assignement (2)</router-link>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <!-- Assignment Table Area End Here -->
        </form>
    </div>
</template>
<script>
