  ...
  <div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
      ...
      <ul>
        ...
        <li>
          <router-link :to="{ name: 'AssignmentMaster' }"
            >Assignment Master</router-link
          >
        </li>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mt-1" v-if="form.attachment_full_url">
              <a :href="form.attachment_full_url" target="_blank">
                View / Download
              </a>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    updateData: function () {
      ...
      this.loaded = 0;
      let apiResponse = api.updateAssignment(this.form.id, params);
      apiResponse
        .then((res) => {
          this.$router
            .push({
