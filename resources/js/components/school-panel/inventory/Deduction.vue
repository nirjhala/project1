            ...
            <div v-if="lists">
              <div class="table-responsive">
                ...
                >
                  ...
                  <template v-for="(listItem, gender) in lists">
                    <tbody :key="gender">
                      <tr>
                      ...
                      <template v-for="(allList, name) in listItem">
                        <tr
                          v-for="(list, j) in allList"
                          :key="`${gender}-${name}-${j}`"
                        >
                          <td>{{ 1 + j }}.</td>
                          <td v-if="j == 0" :rowspan="allList.length">
                            {{ list.name }}
                          </td>
