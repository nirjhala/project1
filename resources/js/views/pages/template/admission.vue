      ...
      <b-container>
        <b-form @submit.prevent="submitForm">
          <b-row>
            <b-col sm="4">
              ...
              >
                ...
                ></b-form-input>
                <b-form-invalid-feedback id="form-father_name-feedback"
            ...
            <b-col sm="4">
              ...
              >
                ...
                ></b-form-input>
                <b-form-invalid-feedback id="form-mothername-feedback"
                  >This is a required field.</b-form-invalid-feedback
                >
              </b-form-group>
            </b-col>
            ...
            <b-col sm="4">
              ...
              >
                ...
                ></b-form-input>
                <b-form-invalid-feedback
                  >Enter valid email.</b-form-invalid-feedback
                >
              </b-form-group>
            </b-col>
            <b-col sm="4">
            ...
            <b-col sm="4">
              ...
              >
                ...
                ></b-form-input>
                <b-form-invalid-feedback
                  >Enter valid phone number.</b-form-invalid-feedback
                >
              </b-form-group>
            </b-col>
          </b-row>
          <b-form-group label="Residential Address" label-for="studentAddress">
            <b-form-textarea
              id="studentAddress"
            ...
            <b-form-invalid-feedback>
              ...
              >
              <span v-if="!$v.form.address.minLength"
                >Min. character must be
                {{ $v.form.address.$params.minLength }}</span
              >
              <span v-if="!$v.form.address.maxLength"
                >Max. character must be
                {{ $v.form.address.$params.maxLength }}</span
              >
            </b-form-invalid-feedback>
          </b-form-group>
          <b-row>
              ...
              >
                ...
                <b-form-invalid-feedback>
                  <span v-if="!$v.form.postcode.required"
                    >This is a required field.</span
                  >
                  <span v-if="!$v.form.postcode.isPincode"
                    >Enter valid 6 digit postcode</span
                  >
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
          ...
          <b-button type="submit" variant="primary" v-if="!loading"
            >Submit <i class="icon-long-arrow-right"></i
          ></b-button>

          <div v-if="loading">
            <b-spinner></b-spinner> Processing, Please wait...
          </div>
    ...
    form: {
      ...
      postcode: {
        ...
        isPincode(postcode) {
          return (
            postcode.length == 0 ||
            (postcode.length == 6 && /[0-9]/.test(postcode))
          );
        },
      },
    },
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (this.$v.form.$anyError) {
        ...
        api.addAdmissionEnquiry({ record: this.form }).then((res) => {
          this.loading = 0;
          this.form = {
            name: "",
            father_name: "",
          ...
          if (res.data) {
            this.success = "Success! Your enquiry has been sent successfully.";
          }
        });
      }
    },
