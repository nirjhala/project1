            ...
            <b-row>
              <b-col sm="3">
                ...
                <ul>
                  ...
                  <li><router-link to="#">Our Mission &amp; Vision</router-link></li>
                  <li><router-link to="#">Chairman's Message</router-link></li>
                  <li><router-link to="#">Principal's Message</router-link></li>
                  <li><router-link to="#">Picture Gallery</router-link></li>
                  <li><router-link to="#">[More&hellip;]</router-link></li>
                </ul>
              </b-col>
              <b-col sm="3">
                <h4>Quick Links</h4>
