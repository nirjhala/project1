...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    searchData: function searchData(page) {
      ...
      instance.get('search-user/?page=' + page + '&s=' + s).then(function (res) {
        _this.loaded = 1;
    ...
    getRecords: function getRecords(page) {
      ...
      instance.get('view-user/?page=' + page).then(function (res) {
        console.log(res.data.data);

        if (res.status) {
          _this2.lists = res.data.data;
          var listArr = res.data.data.data;
          console.log(listArr[0].media.image); // this.lists.pincode_data = res.data.data;
        } else {
          _this2.errors = 1;
        }
      ...
      if (this.check.length > 0) {
        swal({
          ...
          if (willDelete) {
            ...
            instance.post('remove-user', params).then(function (res) {
              if (res.status) {
                _this3.getRecords();
                              ...
                              _c(
                                ...
                                _vm._l(_vm.lists.data, function(list, i) {
                                  return _c("tr", { key: i }, [
                                    ...
                                    _c("td", [
                                      _c("strong", [
                                        _vm._v(_vm._s(list.role_name.name))
                                      ])
                                    ]),
                                    _vm._v(" "),
                                    _c(
